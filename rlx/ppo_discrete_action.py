...
class Agent(nn.Module):
    ...
    def get_action_and_value(self, x, action=None):
        ...
        log_prob = self.get_log_prob(log_probs, action)
...
def loss_fn(
    ...
    ratios = mx.exp(log_ratio)
    pg_loss1 = -mb_advantages * ratios
    pg_loss2 = -mb_advantages * mx.clip(ratios, 1 - clip_coef, 1 + clip_coef)
